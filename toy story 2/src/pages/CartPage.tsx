  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center py-12 px-4 text-center !bg-slate-50">
        ...
        <h2 className="text-2xl font-bold text-red-500 mb-2 font-red-hat">
          Giỏ hàng của bạn đang trống
        </h2>
        <p className="text-red-500 mb-8 max-w-md font-reddit-sans">
          Có vẻ như bạn chưa chọn được món quà ưng ý nào. Hãy quay lại cửa hàng
          để khám phá hàng ngàn món đồ chơi hấp dẫn nhé!
        </p>
        <Link
          to={ROUTES.PRODUCTS}
          ...
          {cartItems.map((item) => (
            ...
            >
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                {item.originalTotalPrice !== undefined &&
                item.originalTotalPrice > (item.serverTotalPrice ?? 0) ? (
                  <div className="mb-2">
                ...
                ) : item.serverTotalPrice !== undefined &&
                  item.serverTotalPrice <
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-3xl p-6 shadow-xl sticky top-24">
            ...
            <div className="space-y-4 mb-6">
              ...
              {getTotalOriginalPrice() > getTotalPrice() && (
                <div className="flex justify-between text-green-600 pb-2">
                  <span>Giảm giá:</span>
                  <span>
                    -{formatPrice(getTotalOriginalPrice() - getTotalPrice())}
                  </span>
                </div>
              )}
            ...
            <p className="text-center text-xs text-gray-400 mt-4 leading-relaxed">
              Bằng cách nhấn thanh toán, bạn đồng ý với các Chính sách và Điều
              khoản của Toy Story.
            </p>
          </div>
        </div>
