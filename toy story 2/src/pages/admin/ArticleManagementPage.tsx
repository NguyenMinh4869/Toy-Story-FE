        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 text-sm font-bold text-white bg-red-400 rounded-2xl hover:bg-red-600 disabled:opacity-50 flex items-center gap-2"
            >
              {loading && (
              ...
              {loading ? 'Đang xử lý...' : currentArticle ? 'Cập nhật' : 'Thêm mới'}
            </button>
          </div>
        </form>
      </Modal>
