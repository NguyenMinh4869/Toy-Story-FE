          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-8 px-4">
                ...
                <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">{setData.totalItems} Món</span>
              </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                       <button
                         ...
                         className="w-10 h-10 flex items-center justify-center rounded-xl bg-red-600 text-white hover:bg-black transition-all shadow-sm border border-transparent"
                         title="Thêm sản phẩm này vào giỏ"
                       >
