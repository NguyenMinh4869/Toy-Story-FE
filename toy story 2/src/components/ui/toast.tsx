...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 right-4 z-[100] flex flex-col gap-2 w-full max-w-[350px]",
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-3 pr-6 shadow-lg transition-all",
  {
    variants: {
      variant: {
        default: "border-gray-200 bg-gray-800 text-white",  // Changed
        destructive: "border-red-500 bg-red-600 text-white", // Explicit red
